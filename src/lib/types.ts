...
export interface DailyLogData {
  ...
  day_stats_mood: string; // Will mirror 'mood'
  day_stats_energy: string; // Will mirror 'energy'
  day_stats_steps: string; // Will mirror 'steps' (final count)
  day_stats_exercise_calories: string; // Will mirror 'schedule_exercise_calories_burned'
